    ...
    const characters = [
        {
            ...
            inventory: JSON.stringify([
                { id: (0, uuid_1.v4)(), name: 'Longbow', type: 'weapon', quantity: 1 },
                { id: (0, uuid_1.v4)(), name: 'Leather Armor', type: 'armor', quantity: 1 },
                { id: (0, uuid_1.v4)(), name: 'Health Potion', type: 'consumable', quantity: 3 },
            ]),
        ...
        },
        {
            ...
            inventory: JSON.stringify([
                { id: (0, uuid_1.v4)(), name: 'Staff of Power', type: 'weapon', quantity: 1 },
                { id: (0, uuid_1.v4)(), name: 'Robes of the Archmagi', type: 'armor', quantity: 1 },
                { id: (0, uuid_1.v4)(), name: 'Spell Component Pouch', type: 'tool', quantity: 1 },
            ]),
            spells: JSON.stringify([
                { id: (0, uuid_1.v4)(), name: 'Fireball', level: 3, school: 'evocation' },
                { id: (0, uuid_1.v4)(), name: 'Magic Missile', level: 1, school: 'evocation' },
                { id: (0, uuid_1.v4)(), name: 'Shield', level: 1, school: 'abjuration' },
            ]),
            background: 'Sage',
